...
-- Resize panel left
map("n", "<M-H>", ":vertical resize -2<CR>", { noremap = true, silent = true, desc = "Resize panel left" })
-- Resize panel right
map("n", "<M-L>", ":vertical resize +2<CR>", { noremap = true, silent = true, desc = "Resize panel right" })
-- Resize panel up
